...
public class AnnotationUtil {
	...
	/**
	 * Returns the field with the given name on the type lowest in the class
	 * hierarchy.
	 * 
	 * @param name
	 *            The name of the field to get
	 * @param type
	 *            The class on which to search for the field.
	 * @return The field with this name lowest in the hierarchy, otherwise null
	 *         if the field does not exist in the class hierarchy.
	 */
	...
	public static List<Field> getAllFieldsWithAnnotation(List<Field> fields,
		...
		if (type.getSuperclass() != null) {
			fields = getAllFieldsWithAnnotation(fields, type.getSuperclass(),
					annotationType);
		}

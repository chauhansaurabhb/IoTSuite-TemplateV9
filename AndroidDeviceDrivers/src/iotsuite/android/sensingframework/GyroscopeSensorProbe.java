...
import iotsuite.android.sensingframework.ProbeKeys.GyroscopeSensorKeys;
...
public class GyroscopeSensorProbe extends Service implements
		SensorEventListener, GyroscopeSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(GyroscopeSensorEvent, data);

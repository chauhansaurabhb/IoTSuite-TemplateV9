...
import iotsuite.android.sensingframework.ProbeKeys.LinearAccelerationSensorKeys;
...
public class LinearAccelerationSensorProbe extends Service implements
		SensorEventListener, LinearAccelerationSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(LinearAccelerationSensorEvent, data);

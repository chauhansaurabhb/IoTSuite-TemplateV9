...
import iotsuite.android.sensingframework.ProbeKeys.MagneticFieldSensorKeys;
...
public class MagneticFieldSensorProbe extends Service implements
		SensorEventListener, MagneticFieldSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(MagneticFieldSensorEvent, data);

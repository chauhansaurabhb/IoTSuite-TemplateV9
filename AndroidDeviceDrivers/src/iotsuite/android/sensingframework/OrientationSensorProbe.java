...
import iotsuite.android.sensingframework.ProbeKeys.OrientationSensorKeys;
...
public class OrientationSensorProbe extends Service implements
		SensorEventListener, OrientationSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(OrientationSensorEvent, data);

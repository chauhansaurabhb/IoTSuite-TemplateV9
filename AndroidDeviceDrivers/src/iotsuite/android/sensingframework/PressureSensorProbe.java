...
import iotsuite.android.sensingframework.ProbeKeys.PressureSensorKeys;
...
public class PressureSensorProbe extends Service implements
		SensorEventListener, PressureSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(PressureSensorEvent, data);

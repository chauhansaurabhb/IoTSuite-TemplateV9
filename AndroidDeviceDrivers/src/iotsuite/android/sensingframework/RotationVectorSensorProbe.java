...
import iotsuite.android.sensingframework.ProbeKeys.RotationVectorSensorKeys;
...
public class RotationVectorSensorProbe extends Service implements
		SensorEventListener, RotationVectorSensorKeys {
	...
	private int getSensorType() {
		return Sensor.TYPE_ROTATION_VECTOR; // SensorKeys.TYPE_ROTATION_VECTOR;
											// // API Level 9
	}

	public String[] getValueNames() {
		return new String[] { X_SIN_THETA_OVER_2, Y_SIN_THETA_OVER_2,
				Z_SIN_THETA_OVER_2, COS_THETA_OVER_2 };
	}
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(RotationVectorSensorEvent, data);

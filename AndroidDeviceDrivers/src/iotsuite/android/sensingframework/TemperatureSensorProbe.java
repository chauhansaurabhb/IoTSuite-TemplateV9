...
public class TemperatureSensorProbe extends Service implements
		SensorEventListener, TemperatureSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(TemperatureSensorEvent, data);

...
public class AccelerometerSensorProbe extends Service implements 
		iotsuite.android.sensingframework.ProbeKeys.AccelerometerSensorKeys, SensorEventListener {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(AccelerometerSensorEvent, data);

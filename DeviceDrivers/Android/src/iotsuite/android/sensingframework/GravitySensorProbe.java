...
import iotsuite.android.sensingframework.ProbeKeys.GravitySensorKeys;
...
public class GravitySensorProbe extends Service implements
		SensorEventListener, GravitySensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(GravitySensorEvent, data);

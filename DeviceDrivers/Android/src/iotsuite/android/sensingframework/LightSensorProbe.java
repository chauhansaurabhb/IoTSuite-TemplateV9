...
import iotsuite.android.sensingframework.ProbeKeys.LightSensorKeys;
...
public class LightSensorProbe extends Service implements
		SensorEventListener, LightSensorKeys {
	...
	private void sendData(final JsonObject data) {
		...
		pubSubSensingFramework.publish(LightSensorEvent, data);
